...
### Unfonts-core (GPLv2; TeX Live r42101)

- Website: http://kldp.net/unfonts/
    - archive: `2607-un-fonts-core-1.0.2-080608.tar.gz`
...
### Unfonts-extra (GPLv2; TeX Live r42102)

- Website: http://kldp.net/unfonts/
    - archive: `2608-un-fonts-extra-1.0.2-080608.tar.gz`
...
### Baekmuk (MIT-like; TeX Live r42106)

- Website: http://kldp.net/baekmuk/
    - archive: `865-baekmuk-ttf-2.2.tar.gz`
...
### Nanum (SIL Open Font License)

- Website: http://hangeul.naver.com/2016/nanum
    - Windows installer: `NanumFontSetup_TTF_ALL_hangeulcamp.exe`
...
### Nanum-extra (SIL Open Font License)
...
### Nanum-osx bundle (SIL Open Font License; converted to ttc by Apple?)
...
### HCR (Free for personal/commercial use)

- Website: http://www.hancom.com/downLoad.downView.do
    - archive: `HancomFont.zip`

Note that all these families have narrow metrics (unavailable in pTeX/upTeX)

|FileName|FullFontName|PostScriptName|
|:--|:--|:--|
|HANBatang.ttf|HCR Batang|HCRBatang|
|HANBatangB.ttf|HCR Batang Bold|HCRBatang-Bold|
|HANDotum.ttf|HCR Dotum|HCRDotum|
|HANDotumB.ttf|HCR Dotum Bold|HCRDotum-Bold|


## non-free

### Adobe (bundled with Adobe Acrobat)
...
### MS-osx (bundled with Office for Mac)

- Office for Mac: `/Library/Fonts/Microsoft/Batang.ttf`, `/Library/Fonts/Microsoft/Gulim.ttf`
...
### Solaris (bundled with Solaris 8 or later)

[TODO]
License statement for fonts themselves is unclear, but Solaris 11 is
licensed under Oracle Technology Network Developer License. OTN license
permits "a perpetual (unless terminated as provided in this agreement),
nonexclusive, nontransferable, limited License to use the Programs only
for the purpose of developing, testing, prototyping and demonstrating
...
### Haansoft (bundled with Hancom Office & Thinkfree Office)

These fonts have white space in PSName.

[WARNING]
These fonts are also available as part of free viewers
"Thinkfree Office viewer" and "HWP Viewer", but the usage of fonts
is restricted by license specification.
On Windows, `HBATANG.TTF` and `HDOTUM.TTF` are installed under
`C:\Program Files (x86)\Hnc\Office NEO\HOfficeViewer96\Shared\TTF\All`.
On Ubuntu, these two (together with HCR families) are installed under
`/usr/share/hnc/hoffice9/viewer/hwpviewer/Shared/TTF/All`.
These fonts are licensed only for use with Hancom Office/Thinkfree Office,
so it is forbidden to use these fonts with TeX/Ghostscript.
(although font files do not have any restriction for embedding)

- Website: http://www.hancom.com/en/product/office_viewer.jsp
    - Windows installer: `HOffice_NEO_Viewer.exe`
